  ...
  return (
    <View style={{paddingLeft: 10, paddingRight: 10, paddingBottom: 5}}>
      ...
      <View style={{flexDirection: 'row'}}>
        <TouchableOpacity style={[{flex: 1, justifyContent: 'space-between',marginRight: 10 }, DefaultStyles.basicBrandColorButton]}>
          <Text style={[{fontSize: 16, fontWeight: 'bold', width: '100%', textAlign: 'center' }, DefaultStyles.brandTextColor]}>Add Address</Text>
        </TouchableOpacity>
        <TouchableOpacity style={[{flex: 1, justifyContent: 'space-between', alignItems: 'center', paddingTop: 8, paddingBottom: 8 }, DefaultStyles.brandColorButton]}>
